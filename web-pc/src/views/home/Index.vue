    ...
    <section class="hero">
      <div class="container">
        ...
        <div class="hero-image">
          <img src="https://via.placeholder.com/600x400/667eea/ffffff?text=乌东风光" alt="乌东风光" />
        </div>
      </div>
    </section>
...
const loadData = () => {
  ...
  hotPosts.value = Array.from({ length: 8 }, (_, i) => ({
    id: i + 1,
    title: `精彩游记标题 ${i + 1}`,
    cover: `https://via.placeholder.com/300x200/667eea/ffffff?text=游记${i + 1}`,
  ...
  hotScenics.value = Array.from({ length: 6 }, (_, i) => ({
    id: i + 1,
    name: `景点名称 ${i + 1}`,
    cover: `https://via.placeholder.com/300x200/764ba2/ffffff?text=景点${i + 1}`,
  ...
  foods.value = Array.from({ length: 5 }, (_, i) => ({
    id: i + 1,
    name: `美食名称 ${i + 1}`,
    image: `https://via.placeholder.com/800x300/f093fb/ffffff?text=美食${i + 1}`,
