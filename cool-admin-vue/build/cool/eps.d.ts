declare namespace Eps {
	...
	interface MerchantMerchantApplyPageResponse {
		pagination: PagePagination;
		list: MerchantApplyEntity[];
	}
	...
	interface SensitiveSensitiveWordPageResponse {
		pagination: PagePagination;
	...
	interface MerchantMerchantApply {
		/**
		 * delete
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * info
		 */
		info(data?: any): Promise<MerchantApplyEntity>;

		/**
		 * list
		 */
		list(data?: any): Promise<MerchantApplyEntity[]>;

		/**
		 * page
		 */
		page(data?: any): Promise<MerchantMerchantApplyPageResponse>;
	...
	interface SensitiveSensitiveWord {
		/**
		 * delete
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * page
		 */
		page(data?: any): Promise<SensitiveSensitiveWordPageResponse>;
