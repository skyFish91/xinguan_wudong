declare namespace Eps {
	...
	interface NotePostEntity {
		...
		/**
		 * 状态 1正常 2审核中 3已下架 4已删除
		 */
		status?: number;

		/**
		 * 审核状态 0待审 1机审通过 2人工通过 3拒绝
		 */
		auditStatus?: number;
	...
	interface OrderEntity {
		...
		/**
		 * 业务类型 GOODS/SEAT/STAY/TICKET/ROUTE
		 */
		bizType?: string;
	...
	interface CommunityNoteCommentPageResponse {
		pagination: PagePagination;
		list: NoteCommentEntity[];
	}

	interface CommunityNotePostPageResponse {
		pagination: PagePagination;
		list: NotePostEntity[];
	}

	interface CommunityNoteReportPageResponse {
		pagination: PagePagination;
		list: NoteReportEntity[];
	}

	interface CommunityNoteTopicPageResponse {
		pagination: PagePagination;
		list: NoteTopicEntity[];
	}
	...
	interface CommunityNoteComment {
		/**
		 * 删除
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * 列表查询
		 */
		list(data?: any): Promise<NoteCommentEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<CommunityNoteCommentPageResponse>;
	...
	interface CommunityNotePost {
		 ...
		 * 列表查询
		 */
		list(data?: any): Promise<NotePostEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<CommunityNotePostPageResponse>;
	...
	interface CommunityNoteReport {
		 ...
		 * 列表查询
		 */
		list(data?: any): Promise<NoteReportEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<CommunityNoteReportPageResponse>;

		/**
		 * 权限标识
		 */
		permission: { handle: string; list: string; page: string };

		/**
		 * 权限状态
		 */
		_permission: { handle: boolean; list: boolean; page: boolean };

		request: Request;
	}

	interface CommunityNoteTopic {
		/**
		 * 删除
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<NoteTopicEntity>;

		/**
		 * 列表查询
		 */
		list(data?: any): Promise<NoteTopicEntity[]>;

		/**
		 * 分页查询
		 */
		page(data?: any): Promise<CommunityNoteTopicPageResponse>;
	...
	type Service = {
		...
		community: {
			noteComment: CommunityNoteComment;
			notePost: CommunityNotePost;
			noteReport: CommunityNoteReport;
			noteTopic: CommunityNoteTopic;
		};
